...
func init() {
	...
	utilruntime.Must(garmv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	flag.StringVar(&watchNamespace, "watch-namespace", os.Getenv("WATCH_NAMESPACE"),
		"Namespace the operator watches. If empty, the operator watches all namespaces.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		Scheme:                 scheme,
		Cache:                  cacheOptions(watchNamespace),
		Metrics:                metricsServerOptions,
		WebhookServer:          webhookServer,
		HealthProbeBindAddress: probeAddr,
		LeaderElection:         enableLeaderElection,
		LeaderElectionID:       "7b6e5bef.igrikus.dev",
	...
	if err := (&controller.RunnerTemplateReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "RunnerTemplate")
		os.Exit(1)
	}
